...
## Hago lo mismo pero con un modelo de reg log clasica, para ver errores

```{r metacog_log_clasica, echo=TRUE}

# corro modelo de regresion clasica
# modelo a3
a3 <- glm(discrimination_is_correct ~ confidence_key.norm,
...
# cuantifico los aciertos de los valores predichos con los verdaderos
y <- d$discrimination_is_correct - trunc(2*a3$fitted)
hits <- sum(y==0)
